package com.yffd.jemsp.sso.cas.rest.controller;

import com.yffd.jemsp.sso.cas.rest.model.SysUser;
import com.yffd.jemsp.sso.cas.rest.repository.UserRepo;
...
public class LoginController {
    ...
    public Object login(@RequestHeader HttpHeaders httpHeaders) {
        ...
        try {
            ...
            //尝试查找用户库是否存在
            user = userRepo.getUser(userTemp.username);
            if (user != null) {
    ...
    private UserTemp obtainUserFormHeader(HttpHeaders httpHeaders) throws UnsupportedEncodingException {
        ...
        LOGGER.debug("headerName authorization: {}", authorization);
