package com.yffd.bcap.sso.middleware.cas.authentication.shiro;
...
public class CustomShiroAuthenticationEventExecutionPlanConfigurer implements AuthenticationEventExecutionPlanConfigurer {
    ...
    public AuthenticationHandler shiroAuthenticationHandler() {
        CustomShiroUsernamePasswordAuthenticationHandler handler = new CustomShiroUsernamePasswordAuthenticationHandler(
                CustomShiroUsernamePasswordAuthenticationHandler.class.getSimpleName(), servicesManager,
    ...
    @Bean
    public CustomShiroAuthorizingRealm customShiroAuthorizingRealm(){
        CustomShiroAuthorizingRealm realm = new CustomShiroAuthorizingRealm();
