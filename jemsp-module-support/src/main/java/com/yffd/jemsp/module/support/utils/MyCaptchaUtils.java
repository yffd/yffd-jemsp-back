...
//    private Random random = new Random();
     ...
     * @return
     */
    public static BufferedImage randomCodeImage(StringBuffer randomCode) {
        MyCaptchaUtils tool = new MyCaptchaUtils();
       return tool.genRandomCodeImage(randomCode);
    }
     ...
     * @return
     */
    private BufferedImage genRandomCodeImage(StringBuffer randomCode) {
